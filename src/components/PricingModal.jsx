...
export default function PricingModal({
  ...
  const handleBonus = async () => {
    ...
    if (res?.ok) {
      alert(isEn ? '✨ Granted 5 follow-up questions for this reading!' : '✨ Bạn đã nhận được 5 câu hỏi thêm cho quẻ này!');
      onClose();
    } else {
    ...
    >
      ...
      >
        ...
        {onApplyCoupon && (
          ...
          >
            <div style={{ fontSize: '0.85rem', color: '#f5d78e', fontWeight: 600, marginBottom: '8px' }}>
